...
;OBSERVAÇÃO - Projeto incompleto: Não foi realizado uma função separada para calcular as médias e só pode calcular e exibir a média de um aluno por vez ao invés de 40
